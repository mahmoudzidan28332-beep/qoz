...
$requiredFiles = [
    ...
    __DIR__ . '/shared/core/ApplicationException.php',
    __DIR__ . '/shared/core/AuthException.php',
    __DIR__ . '/shared/core/AuthorizationException.php',
    __DIR__ . '/shared/core/SystemException.php',
