...
final class AdPlacementsService
{
    private PdoAdPlacementsRepository $repo;

    public function __construct(PdoAdPlacementsRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    public function get(int $tenantId, int $id): array
    {
        ...
        if (!$data) {
            throw new ApplicationException('Ad placement not found');
        }
        return $data;
    }
    ...
    {
        $validator = new AdPlacementsValidator();
