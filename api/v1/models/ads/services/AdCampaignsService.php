...
final class AdCampaignsService
{
    private PdoAdCampaignsRepository $repo;

    public function __construct(PdoAdCampaignsRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    {
        $validator = new AdCampaignsValidator();
