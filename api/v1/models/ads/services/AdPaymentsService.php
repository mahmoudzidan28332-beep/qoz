...
final class AdPaymentsService
{
    private PdoAdPaymentsRepository $repo;

    public function __construct(PdoAdPaymentsRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    {
        $validator = new AdPaymentsValidator();
