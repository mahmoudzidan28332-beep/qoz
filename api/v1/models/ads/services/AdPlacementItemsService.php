...
final class AdPlacementItemsService
{
    private PdoAdPlacementItemsRepository $repo;

    public function __construct(PdoAdPlacementItemsRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    {
        $validator = new AdPlacementItemsValidator();
