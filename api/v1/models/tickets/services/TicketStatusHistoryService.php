...
final class TicketStatusHistoryService
{
    private PdoTicketStatusHistoryRepository $repo;

    public const WHITELISTED_COLUMNS = [
        'ticket_id', 'old_status', 'new_status', 'changed_by', 'notes', 'id'
    ];

    public function __construct(PdoTicketStatusHistoryRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    {
        $validator = new TicketStatusHistoryValidator();
