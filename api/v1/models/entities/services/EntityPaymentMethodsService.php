...
final class EntityPaymentMethodsService
{
    private PdoEntityPaymentMethodsRepository $repo;

    public function __construct(PdoEntityPaymentMethodsRepository $repo)
    {
        $this->repo = $repo;
    }
