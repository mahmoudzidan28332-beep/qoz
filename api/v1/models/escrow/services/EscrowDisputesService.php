...
final class EscrowDisputesService
{
    private PdoEscrowDisputesRepository $repo;

    public function __construct(PdoEscrowDisputesRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    {
        $validator = new EscrowDisputesValidator();
