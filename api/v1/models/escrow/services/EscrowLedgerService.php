...
final class EscrowLedgerService
{
    private PdoEscrowLedgerRepository $repo;

    public function __construct(PdoEscrowLedgerRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    {
        $validator = new EscrowLedgerValidator();
