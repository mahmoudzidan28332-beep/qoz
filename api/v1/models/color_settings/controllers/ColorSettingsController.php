...
// api/v1/models/color_settings/controllers/ColorSettingsController.php

final class ColorSettingsController
{
    private ColorSettingsService $service;

    public function __construct(ColorSettingsService $service)
    {
