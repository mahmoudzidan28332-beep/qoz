...
final class PdoColorSettingsRepository
{
    private PDO $pdo;
    ...
    public function save(int $tenantId, array $data): int
    {
        ...
        $stmt = $this->pdo->prepare("
            INSERT INTO color_settings
                (tenant_id, theme_id, setting_key, setting_name, color_value, category, is_active, sort_order, created_at)
            VALUES
                (:tenantId, :theme_id, :key, :name, :color_value, :category, :is_active, :sort_order, NOW())
        ");
