 ...
 * DeliveryZoneService
 *
 * Business logic layer for Delivery Zones.
 *
 * Location: api/v1/models/delivery_zones/services/DeliveryZoneService.php
 */
final class DeliveryZoneService
{
    private DeliveryZoneRepositoryInterface $repo;
    private DeliveryZoneValidator $validator;

    public function __construct(
        DeliveryZoneRepositoryInterface $repo,
        DeliveryZoneValidator $validator
    ) {
        $this->repo      = $repo;
