...
final class PdoJobInterviewsRepository
{
    ...
    public function all(
        ...
        $sql = "
            ...
            INNER JOIN job_applications ja ON ji.application_id = ja.id
            INNER JOIN jobs j ON ja.job_id = j.id
            INNER JOIN entities e ON j.entity_id = e.id
        ...
        if ($tenantId !== null) {
            // 🔒 SECURITY: checkOwnership Enforce tenant isolation
