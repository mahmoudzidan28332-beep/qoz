...
final class SeoMetaService
{
    ...
    public const WHITELISTED_COLUMNS = [
        'tenant_id', 'entity_type', 'entity_id', 'canonical_url', 'robots', 'schema_markup', 'id'
    ];
    ...
    public function create(array $data): int
    {
        ...
        SeoMetaValidator::validateCreate($whitelisted);
    ...
    public function update(int $id, array $data): int
    {
        ...
        SeoMetaValidator::validateUpdate($whitelisted);
        return $this->repo->save($whitelisted);
    }
