...
final class ReturnStatusHistoryService
{
    private PdoReturnStatusHistoryRepository $repo;

    public const WHITELISTED_COLUMNS = [
        'return_id', 'status', 'notes', 'changed_by', 'id'
    ];

    public function __construct(PdoReturnStatusHistoryRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    {
        $validator = new ReturnStatusHistoryValidator();
