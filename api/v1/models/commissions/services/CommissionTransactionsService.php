...
class CommissionTransactionsService {
    private PdoCommissionTransactionsRepository $repo;

    public function __construct(PdoCommissionTransactionsRepository $repo) {
        $this->repo = $repo;
    }
