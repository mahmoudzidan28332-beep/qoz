...
class CommissionPaymentsService {
    private PdoCommissionPaymentsRepository $repo;

    public function __construct(PdoCommissionPaymentsRepository $repo) {
        $this->repo = $repo;
    }
    ...
    public function generatePaymentNumber(): string { return $this->repo->generatePaymentNumber(); }
}
