...
class CommissionInvoiceItemsService {
    private PdoCommissionInvoiceItemsRepository $repo;

    public function __construct(PdoCommissionInvoiceItemsRepository $repo) {
        $this->repo = $repo;
    }
    ...
    public function listByInvoice(int $invoiceId): array { return $this->repo->listByInvoice($invoiceId); }
