...
class CommissionCreditNotesService {
    private PdoCommissionCreditNotesRepository $repo;

    public function __construct(PdoCommissionCreditNotesRepository $repo) {
        $this->repo = $repo;
    }
    ...
    public function stats(?int $tenantId = null): array { return $this->repo->stats($tenantId); }
    public function generateCreditNoteNumber(): string { return $this->repo->generateCreditNoteNumber(); }
}
