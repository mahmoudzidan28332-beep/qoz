...
class CommissionPaymentsController {
    private CommissionPaymentsService $service;

    public function __construct(CommissionPaymentsService $service) {
    ...
    public function generatePaymentNumber(): string { return $this->service->generatePaymentNumber(); }
}
