...
final class PdoFontSettingsRepository
{
    private PDO $pdo;
    ...
    public function save(int $tenantId, array $data): int
    {
        ...
        $stmt = $this->pdo->prepare("
            INSERT INTO font_settings
                (tenant_id, theme_id, setting_key, setting_name, font_family, font_size, font_weight, line_height, category, is_active, sort_order, created_at)
            VALUES
                (:tenantId, :theme_id, :key, :name, :font_family, :font_size, :font_weight, :line_height, :category, :is_active, :sort_order, NOW())
        ");
