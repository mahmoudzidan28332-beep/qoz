...
// api/v1/models/products/controllers/ProductAttributesController.php

final class ProductAttributesController
{
    ...
    {
        $attributeTypeId = isset($_GET['attribute_type_id']) ? (int)$_GET['attribute_type_id'] : null;
        $lang = $_GET['lang'] ?? 'en';
        return $this->service->list($attributeTypeId, $lang);
    }
