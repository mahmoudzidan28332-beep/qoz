...
{
    private ProductRelationsService $service;

    public function __construct(ProductRelationsService $service)
    {
    ...
    {
        return $this->service->deleteByProduct($tenantId, $productId, $relationType);
    }

    public function getRelatedProducts(int $tenantId, int $productId, ?string $relationType, string $lang): array
    {
        return $this->service->getRelatedProducts($tenantId, $productId, $relationType, $lang);
    }
}