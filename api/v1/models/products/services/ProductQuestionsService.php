...
final class ProductQuestionsService
{
    private PdoProductQuestionsRepository $repo;
    private ProductQuestionsValidator $validator;

    public function __construct(PdoProductQuestionsRepository $repo, ProductQuestionsValidator $validator)
    {
        $this->repo = $repo;
    ...
    {
        return $this->repo->deleteByProduct($tenantId, $productId);
    }

    public function incrementHelpful(int $tenantId, int $id): bool
    {
        return $this->repo->incrementHelpful($tenantId, $id);
    }
}