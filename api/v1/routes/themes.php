    ...
    switch ($method) {
        ...
        case 'GET':
            if (str_contains($uri, '/themes/active')) {
                ...
                ResponseFormatter::success($controller->getDefault($tenantId));
            } else {
                $slug = $_GET['slug'] ?? null;
                if ($slug) {
        ...
        case 'POST':
            if (str_contains($uri, '/themes/activate')) {
                ResponseFormatter::success($controller->activate($tenantId, $data));
            } elseif (str_contains($uri, '/themes/set-default')) {
                ResponseFormatter::success($controller->setDefault($tenantId, $data));
            } else {
