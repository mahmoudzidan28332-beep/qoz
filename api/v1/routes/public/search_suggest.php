...
if ($searchEntityId && $tenantId && class_exists('MultiTenantValidator')) {
    if (!MultiTenantValidator::checkOwnership($pdo, 'entities', $searchEntityId, $tenantId)) {
        // Silently ignore invalid entity focus for public routes
        $searchEntityId = null;
    }
}
