...
$modelsPath = API_VERSION_PATH . '/models/font_settings';
require_once $modelsPath . '/repositories/PdoFontSettingsRepository.php';
require_once $modelsPath . '/validators/FontSettingsValidator.php';
require_once $modelsPath . '/services/FontSettingsService.php';
require_once $modelsPath . '/controllers/FontSettingsController.php';
...
try {
    ...
    switch ($method) {
        ...
        case 'GET':
            if (str_contains($uri, '/font_settings/active')) {
                ResponseFormatter::success($controller->getActive($tenantId));
            } elseif (str_contains($uri, '/font_settings/categories')) {
        ...
        case 'POST':
            if (str_contains($uri, '/font_settings/bulk')) {
    ...
    safe_log('warning', 'font_settings.validation', ['error' => $e->getMessage()]);
