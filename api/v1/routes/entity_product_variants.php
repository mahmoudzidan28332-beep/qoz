...
try {
    ...
    switch ($method) {
        ...
        case 'GET':
            ...
            // GET /api/entity_product_variants?id={id}&entity_id={id}
        ...
        case 'POST':
            // POST /api/entity_product_variants?action=bulk&entity_id={id}
        ...
        case 'DELETE':
            ...
            // DELETE /api/entity_product_variants?id={id}&entity_id={id}
