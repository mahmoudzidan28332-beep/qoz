...
$effectiveTenantId = $tenantId !== null ? (int)$tenantId : ($isPlatformAdmin ? 1 : 0);
...
window.THEMES_CONFIG = {
    ...
    IS_PLATFORM_ADMIN: <?= $isPlatformAdmin ? 'true' : 'false' ?>,
...
<div class="themes-page" id="themesPageContainer" dir="<?= htmlspecialchars($dir) ?>">
    ...
    <div id="themesListView">
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group">
                        <label for="assignmentTarget">Apply To</label>
                        <select id="assignmentTarget" class="form-control">
                            <option value="tenant_store">Tenant Store</option>
                            <?php if ($isPlatformAdmin): ?>
                            <option value="platform_admin">Platform Admin</option>
                            <option value="platform_home">Platform Home</option>
                            <?php endif; ?>
                        </select>
                    </div>
                    <div class="form-group" id="assignmentTenantWrap" <?= $isPlatformAdmin ? '' : 'style="display:none"' ?>>
                        <label for="assignmentTenantId">Tenant</label>
                        <select id="assignmentTenantId" class="form-control">
                            <option value="<?= (int)$effectiveTenantId ?>">Tenant #<?= (int)$effectiveTenantId ?></option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="assignmentThemeId">Selected Theme</label>
                        <select id="assignmentThemeId" class="form-control">
                            <option value="">Select theme</option>
                        </select>
                    </div>
                </div>
                <div class="page-header-actions" style="justify-content:flex-start;">
                    <button class="btn btn-secondary" id="btnApplyActiveTheme" type="button">
                        <i class="fas fa-check"></i>
                        <span>Apply Active</span>
                    </button>
                    <button class="btn btn-secondary" id="btnApplyDefaultTheme" type="button">
                        <i class="fas fa-star"></i>
                        <span>Apply Default</span>
                    </button>
                </div>
                <div id="currentThemeSelectionSummary" style="margin-top:10px;color:var(--text-secondary,#94a3b8);font-size:13px;"></div>
            </div>
        </div>
        ...
        <div class="filters-bar">
            ...
            <select id="themeTargetFilter" class="form-control">
                <option value="tenant_store">Tenant Store</option>
                <?php if ($isPlatformAdmin): ?>
                <option value="platform_admin">Platform Admin</option>
                <option value="platform_home">Platform Home</option>
    ...
    <div id="themeFormView" style="display:none">
        ...
        <div class="tab-content active" id="tab-info">
            <form id="themeForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label for="themeScope">Scope</label>
                        <select id="themeScope" class="form-control">
                    ...
                    <div class="form-group">
                        <label for="themeTarget">Target</label>
                        <select id="themeTarget" class="form-control">
                            <option value="tenant_store">Tenant Store</option>
                            <?php if ($isPlatformAdmin): ?>
                            <option value="platform_admin">Platform Admin</option>
                            <option value="platform_home">Platform Home</option>
