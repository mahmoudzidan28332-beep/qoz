 ...
 * 
 * Production-hardened fragment for product management (Zero-Finding).
 */
...
if (file_exists($_prdLangFile)) {
    $_prdJson = json_decode((string)file_get_contents($_prdLangFile), true);
...
/**
 * Localization helper for product module strings.
 */
...
?>
<link rel="stylesheet" href="/admin/assets/css/pages/products.css?v=<?= htmlspecialchars(assetVer('/admin/assets/css/pages/products.css')) ?>">

<meta data-page="products"
      data-assets-js="/admin/assets/js/pages/products.js"
      data-i18n-files="/languages/Product/<?= htmlspecialchars(rawurlencode($_prdSafeLang)) ?>.json">
...
<div class="page-container" id="productsPageContainer" dir="<?= htmlspecialchars($dir) ?>">
    ...
    <div class="page-header">
        <div class="page-header-content">
            <h1 class="page-title" data-i18n="products.title"><?= htmlspecialchars(_prd('products.title', 'Products')) ?></h1>
            <p class="page-subtitle" data-i18n="products.subtitle"><?= htmlspecialchars(_prd('products.subtitle', 'Manage your product catalog')) ?></p>
        </div>
        <div class="page-header-actions">
            <?php if ($canCreate): ?>
            <button id="btnImportCsv" class="btn btn-secondary">
                <i class="fas fa-file-csv"></i>
                <span data-i18n="csv.import_button"><?= htmlspecialchars(_prd('csv.import_button', 'Import CSV')) ?></span>
            </button>
            <button id="btnAddProduct" class="btn btn-primary">
                <i class="fas fa-plus"></i>
                <span data-i18n="products.add_new"><?= htmlspecialchars(_prd('products.add_new', 'Add Product')) ?></span>
            </button>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div id="productFormContainer" class="card form-card" style="display:none">
        <div class="card-header">
            <h3 class="card-title" id="formTitle" data-i18n="form.add_title"><?= htmlspecialchars(_prd('form.add_title', 'Add Product')) ?></h3>
            <button type="button" class="btn btn-secondary cancel-btn" id="btnCloseForm" aria-label="<?= htmlspecialchars(_prd('accessibility.close', 'Close')) ?>">
            ...
            <form id="productForm" novalidate>
                ...
                <div class="form-tabs">
                    <button type="button" class="tab-btn active" data-tab="general">
                        ...
                        <span data-i18n="tabs.general"><?= htmlspecialchars(_prd('tabs.general', 'General')) ?></span>
                    </button>
                    <button type="button" class="tab-btn" data-tab="physical">
                        <i class="fas fa-ruler-combined"></i>
                        <span data-i18n="tabs.physical"><?= htmlspecialchars(_prd('tabs.physical', 'Physical Attributes')) ?></span>
                    </button>
                    <button type="button" class="tab-btn" data-tab="attributes">
                        <i class="fas fa-list-alt"></i>
                        <span data-i18n="tabs.attributes"><?= htmlspecialchars(_prd('tabs.attributes', 'Attributes')) ?></span>
                    </button>
                    <button type="button" class="tab-btn" data-tab="variants">
                        <i class="fas fa-layer-group"></i>
                        <span data-i18n="tabs.variants"><?= htmlspecialchars(_prd('tabs.variants', 'Variants')) ?></span>
                    </button>
                    <button type="button" class="tab-btn" data-tab="images">
                        <i class="fas fa-images"></i>
                        <span data-i18n="tabs.images"><?= htmlspecialchars(_prd('tabs.images', 'Images')) ?></span>
                    </button>
                    <button type="button" class="tab-btn" data-tab="translations">
                        <i class="fas fa-language"></i>
                        <span data-i18n="tabs.translations"><?= htmlspecialchars(_prd('tabs.translations', 'Translations')) ?></span>
                    </button>
                </div>
                ...
                <div class="tab-content active" id="tab-general">
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodSku" data-i18n="form.fields.sku.label">
                                <?= htmlspecialchars(_prd('form.fields.sku.label', 'SKU')) ?>
                            </label>
                            <input type="text" id="prodSku" name="sku" class="form-control"
                                   data-i18n-placeholder="form.fields.sku.placeholder"
                                   placeholder="<?= htmlspecialchars(_prd('form.fields.sku.placeholder', 'Auto-generated if empty')) ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodType" data-i18n="form.fields.product_type.label">
                                <?= htmlspecialchars(_prd('form.fields.product_type.label', 'Product Type')) ?>
                            </label>
                            <select id="prodType" name="product_type_id" class="form-control">
                                <option value=""><?= htmlspecialchars(_prd('common.loading', 'Loading...')) ?></option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="prodBrand" data-i18n="form.fields.brand.label">
                                <?= htmlspecialchars(_prd('form.fields.brand.label', 'Brand')) ?>
                            </label>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodIsActive" data-i18n="form.fields.status.label">
                                <?= htmlspecialchars(_prd('form.fields.status.label', 'Status')) ?>
                            </label>
                            <select id="prodIsActive" name="is_active" class="form-control">
                                <option value="1" data-i18n="form.fields.status.active">
                                    <?= htmlspecialchars(_prd('form.fields.status.active', 'Active')) ?>
                                </option>
                                <option value="0" data-i18n="form.fields.status.inactive">
                                    <?= htmlspecialchars(_prd('form.fields.status.inactive', 'Inactive')) ?>
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="prodIsBestseller" data-i18n="form.fields.bestseller.label">
                                <?= htmlspecialchars(_prd('form.fields.bestseller.label', 'Bestseller')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodIsNew" data-i18n="form.fields.new.label">
                                <?= htmlspecialchars(_prd('form.fields.new.label', 'New')) ?>
                            </label>
                    ...
                    <h4 class="section-heading" data-i18n="tabs.pricing">
                        <i class="fas fa-tag"></i> <?= htmlspecialchars(_prd('tabs.pricing', 'Pricing')) ?>
                    </h4>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodPrice" data-i18n="form.fields.price.label">
                                <?= htmlspecialchars(_prd('form.fields.price.label', 'Price')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodComparePrice" data-i18n="form.fields.compare_price.label">
                                <?= htmlspecialchars(_prd('form.fields.compare_price.label', 'Compare at Price')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodCostPrice" data-i18n="form.fields.cost_price.label">
                                <?= htmlspecialchars(_prd('form.fields.cost_price.label', 'Cost Price')) ?>
                            </label>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodCurrency" data-i18n="form.fields.currency.label">
                                <?= htmlspecialchars(_prd('form.fields.currency.label', 'Currency')) ?>
                            </label>
                            <select id="prodCurrency" name="currency_code" class="form-control">
                                <option value=""><?= htmlspecialchars(_prd('form.fields.currency.select', 'Select currency')) ?></option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="prodTaxRate" data-i18n="form.fields.tax_rate.label">
                                <?= htmlspecialchars(_prd('form.fields.tax_rate.label', 'Tax Rate %')) ?>
                            </label>
                    ...
                    <h4 class="section-heading" data-i18n="tabs.inventory">
                        <i class="fas fa-boxes"></i> <?= htmlspecialchars(_prd('tabs.inventory', 'Inventory')) ?>
                    </h4>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodStockQty" data-i18n="form.fields.stock_quantity.label">
                                <?= htmlspecialchars(_prd('form.fields.stock_quantity.label', 'Stock Quantity')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodLowStock" data-i18n="form.fields.low_stock_threshold.label">
                                <?= htmlspecialchars(_prd('form.fields.low_stock_threshold.label', 'Low Stock Threshold')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodStockStatus" data-i18n="form.fields.stock_status.label">
                                <?= htmlspecialchars(_prd('form.fields.stock_status.label', 'Stock Status')) ?>
                            </label>
                            <select id="prodStockStatus" name="stock_status" class="form-control">
                                <option value="in_stock" data-i18n="form.fields.stock_status.in_stock"><?= htmlspecialchars(_prd('form.fields.stock_status.in_stock', 'In Stock')) ?></option>
                                <option value="out_of_stock" data-i18n="form.fields.stock_status.out_of_stock"><?= htmlspecialchars(_prd('form.fields.stock_status.out_of_stock', 'Out of Stock')) ?></option>
                                <option value="on_backorder" data-i18n="form.fields.stock_status.on_backorder"><?= htmlspecialchars(_prd('form.fields.stock_status.on_backorder', 'On Backorder')) ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodManageStock" data-i18n="form.fields.manage_stock.label">
                                <?= htmlspecialchars(_prd('form.fields.manage_stock.label', 'Manage Stock')) ?>
                            </label>
                            <select id="prodManageStock" name="manage_stock" class="form-control">
                                <option value="1" data-i18n="form.fields.manage_stock.yes"><?= htmlspecialchars(_prd('form.fields.manage_stock.yes', 'Yes')) ?></option>
                                <option value="0" data-i18n="form.fields.manage_stock.no"><?= htmlspecialchars(_prd('form.fields.manage_stock.no', 'No')) ?></option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="prodAllowBackorder" data-i18n="form.fields.allow_backorder.label">
                                <?= htmlspecialchars(_prd('form.fields.allow_backorder.label', 'Allow Backorder')) ?>
                            </label>
                            <select id="prodAllowBackorder" name="allow_backorder" class="form-control">
                                <option value="0" data-i18n="form.fields.allow_backorder.no"><?= htmlspecialchars(_prd('form.fields.allow_backorder.no', 'No')) ?></option>
                                <option value="1" data-i18n="form.fields.allow_backorder.yes"><?= htmlspecialchars(_prd('form.fields.allow_backorder.yes', 'Yes')) ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <h4 class="section-heading" data-i18n="tabs.categories">
                        <i class="fas fa-folder-tree"></i> <?= htmlspecialchars(_prd('tabs.categories', 'Categories')) ?>
                    </h4>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodWeight" data-i18n="form.fields.weight.label">
                                <?= htmlspecialchars(_prd('form.fields.weight.label', 'Weight')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodWeightUnit" data-i18n="form.fields.weight_unit.label">
                                <?= htmlspecialchars(_prd('form.fields.weight_unit.label', 'Weight Unit')) ?>
                            </label>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label for="prodLength" data-i18n="form.fields.length.label">
                                <?= htmlspecialchars(_prd('form.fields.length.label', 'Length')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodWidth" data-i18n="form.fields.width.label">
                                <?= htmlspecialchars(_prd('form.fields.width.label', 'Width')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodHeight" data-i18n="form.fields.height.label">
                                <?= htmlspecialchars(_prd('form.fields.height.label', 'Height')) ?>
                            </label>
                        ...
                        <div class="form-group">
                            <label for="prodDimensionUnit" data-i18n="form.fields.dimension_unit.label">
                                <?= htmlspecialchars(_prd('form.fields.dimension_unit.label', 'Dimension Unit')) ?>
                            </label>
                ...
                <div class="tab-content" id="tab-attributes" style="display:none">
                    <div class="attrs-controls">
                        ...
                        <button type="button" id="btnAddAttribute" class="btn btn-primary" data-i18n="form.buttons.add_attribute">
                            <?= htmlspecialchars(_prd('form.buttons.add_attribute', 'Add Attribute')) ?>
                        </button>
                    </div>
                ...
                <div class="tab-content" id="tab-variants" style="display:none">
                    <div class="variant-controls">
                        <button type="button" id="btnGenerateVariants" class="btn btn-secondary" data-i18n="form.buttons.generate_variants">
                            <?= htmlspecialchars(_prd('form.buttons.generate_variants', 'Generate Variants from Attributes')) ?>
                        </button>
                        <button type="button" id="btnAddVariant" class="btn btn-primary" data-i18n="form.buttons.add_variant">
                            <?= htmlspecialchars(_prd('form.buttons.add_variant', 'Add Variant Manually')) ?>
                        </button>
                    </div>
                ...
                <div class="tab-content" id="tab-images" style="display:none">
                    <div class="form-group">
                        <label data-i18n="form.fields.images.label">
                            <?= htmlspecialchars(_prd('form.fields.images.label', 'Product Images')) ?>
                        </label>
                        <div class="image-upload-section">
                            <button type="button" id="prodSelectImageBtn" class="btn btn-secondary btn-full-width" data-i18n="common.select_image">
                                <?= htmlspecialchars(_prd('common.select_image', 'Select Images from Studio')) ?>
                            </button>
                ...
                <div class="tab-content" id="tab-translations" style="display:none">
                    <div class="translations-section">
                        ...
                        <div class="info-hint-box">
                            <i class="fas fa-info-circle"></i>
                            <strong>English</strong> translation fields are in the <strong>General tab</strong>. Use this tab to add translations for other languages.
                        </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary" id="btnSubmitForm">
                        ...
                        <span data-i18n="form.buttons.save"><?= htmlspecialchars(_prd('form.buttons.save', 'Save')) ?></span>
                    </button>
                    <button type="button" class="btn btn-secondary cancel-btn" id="btnCancelForm" data-i18n="form.buttons.cancel">
                        <i class="fas fa-times" aria-hidden="true"></i>
                        <?= htmlspecialchars(_prd('form.buttons.cancel', 'Cancel')) ?>
                    </button>
                    <?php if ($canDelete): ?>
                    <button type="button" id="btnDeleteProduct" class="btn btn-danger" style="display:none">
                        <i class="fas fa-trash"></i>
                        <span data-i18n="table.actions.delete"><?= htmlspecialchars(_prd('table.actions.delete', 'Delete')) ?></span>
                    </button>
                    <?php endif; ?>
                </div>
            </form>
            ...
            <div class="filters-grid">
                <div class="filter-group">
                    <label class="filter-label" for="searchInput" data-i18n="filters.search">
                        <?= htmlspecialchars(_prd('filters.search', 'Search')) ?>
                    </label>
                    <input type="text" id="searchInput" class="form-control"
                           data-i18n-placeholder="filters.search_placeholder"
                           placeholder="<?= htmlspecialchars(_prd('filters.search_placeholder', 'Search products...')) ?>">
                </div>

                <?php if ($isSuperAdmin || $isPlatformAdmin): ?>
                <div class="filter-group">
                    <label class="filter-label" for="tenantFilter" data-i18n="filters.tenant_id">
                        <?= htmlspecialchars(_prd('filters.tenant_id', 'Tenant ID')) ?>
                    </label>
                    <input type="number" id="tenantFilter" class="form-control" value="<?= (int)$tenantId ?>"
                           data-i18n-placeholder="filters.tenant_placeholder"
                           placeholder="<?= htmlspecialchars(_prd('filters.tenant_placeholder', 'Filter by tenant')) ?>">
                </div>
                <?php endif; ?>
                ...
                <div class="filter-group">
                    <label class="filter-label" for="statusFilter" data-i18n="filters.status">
                        <?= htmlspecialchars(_prd('filters.status', 'Status')) ?>
                    </label>
                ...
                <div class="filter-group">
                    ...
                    <div class="filter-buttons">
                        <button id="btnApplyFilters" class="btn btn-primary" data-i18n="filters.apply">
                            <?= htmlspecialchars(_prd('filters.apply', 'Apply')) ?>
                        </button>
                        <button id="btnResetFilters" class="btn btn-secondary" data-i18n="filters.reset">
                            <?= htmlspecialchars(_prd('filters.reset', 'Reset')) ?>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="card table-card">
        <div class="card-body">
            <div id="pageLoading" class="loading-state" style="display:none;">
                ...
                <p data-i18n="products.loading"><?= htmlspecialchars(_prd('products.loading', 'Loading...')) ?></p>
            </div>
    ...
    <!-- Modals -->
    <div id="prodMediaStudioModal" class="prd-modal-backdrop" role="dialog" aria-modal="true" style="display:none;">
        <div class="prd-modal-panel prd-modal-panel--wide">
            <div class="prd-modal-header">
                <h3 data-i18n="tabs.images"><?= htmlspecialchars(_prd('tabs.images', 'Images')) ?></h3>
                <button type="button" id="prodMediaStudioClose" class="btn-close-modal icon-btn">
                    <i class="fas fa-times" aria-hidden="true"></i>
                </button>
            </div>
            <div class="prd-modal-body">
                <iframe id="prodMediaStudioFrame" class="media-studio-iframe" src="/admin/fragments/media_studio.php?embedded=1&tenant_id=<?= (int)$tenantId ?>&lang=<?= htmlspecialchars(rawurlencode($_prdSafeLang)) ?>"></iframe>
            </div>
        </div>
    </div>

    <div id="csvImportModal" class="prd-modal-backdrop" role="dialog" aria-modal="true" style="display:none;">
        <div class="prd-modal-panel csv-modal-content">
            <div class="prd-modal-header">
                <h3>
                    <i class="fas fa-file-csv"></i>
                    <span data-i18n="csv.title"><?= htmlspecialchars(_prd('csv.title', 'Import Products via CSV')) ?></span>
                </h3>
                <button type="button" id="csvImportClose" class="btn-close-modal icon-btn">
                    <i class="fas fa-times" aria-hidden="true"></i>
                </button>
            </div>
            <div class="prd-modal-body">
                <div class="info-hint-box csv-instructions">
                    <p>
                        <i class="fas fa-info-circle"></i>
                        <span data-i18n="csv.instructions"><?= htmlspecialchars(_prd('csv.instructions', 'Upload a CSV file to bulk-import products. Max 1000 rows per file recommended.')) ?></span>
                    </p>
                </div>
                ...
                <div class="csv-download-section">
                    <button type="button" id="btnDownloadSample" class="btn btn-outline btn-full-width">
                        ...
                        <span data-i18n="csv.download_sample"><?= htmlspecialchars(_prd('csv.download_sample', 'Download Sample CSV Template')) ?></span>
                    </button>
                </div>

                <div class="form-group csv-file-group">
                    <label data-i18n="csv.choose_file"><?= htmlspecialchars(_prd('csv.choose_file', 'Select CSV File')) ?></label>
                ...
                <div id="csvProgressArea" class="csv-progress-area" style="display:none;">
                    <div class="csv-progress-header">
                        <span id="csvProgressLabel" class="csv-progress-label" data-i18n="csv.importing"><?= htmlspecialchars(_prd('csv.importing', 'Importing…')) ?></span>
                        <span id="csvProgressPct" class="csv-progress-pct">0%</span>
                    </div>
                    <div class="csv-progress-track"><div id="csvProgressBar" class="csv-progress-bar"></div></div>
                    <div id="csvProgressLog" class="csv-progress-log"></div>
                </div>

                <div class="csv-actions">
                    <button type="button" id="csvImportCancel" class="btn btn-secondary" data-i18n="csv.cancel"><?= htmlspecialchars(_prd('csv.cancel', 'Cancel')) ?></button>
                    <button type="button" id="csvImportStart" class="btn btn-primary" disabled>
                        <i class="fas fa-upload"></i>
                        <span data-i18n="csv.import"><?= htmlspecialchars(_prd('csv.import', 'Start Import')) ?></span>
                    </button>
                </div>
            </div>
        </div>
...
<script src="/admin/assets/js/pages/products.js?v=<?= htmlspecialchars(assetVer('/admin/assets/js/pages/products.js')) ?>"></script>
