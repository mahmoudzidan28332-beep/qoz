...
<?php if ($isFragment): ?>
<link rel="stylesheet" href="/admin/assets/css/pages/pos.css?v=<?= assetVer() ?>">
<?php endif; ?>

<!-- Page Meta (fragment loader uses these) -->
<meta data-page="pos"
      data-assets-css="/admin/assets/css/pages/pos.css?v=<?= assetVer() ?>"
...
<div class="pos-page" id="posPageContainer" dir="<?= htmlspecialchars($dir) ?>">
    ...
    <div class="pos-panel" id="posHistoryPanel" style="display:none">
        <div class="pos-panel-header">
            ...
            <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
                <button class="btn btn-sm btn-secondary pos-export-btn" id="posExportHistoryCSV" title="<?= __pos_t('pos.reports.export_csv', 'Export CSV') ?>">
                    📥 <?= __pos_t('pos.reports.export_csv', 'Export CSV') ?>
                </button>
                <button class="btn btn-sm btn-secondary pos-export-btn" id="posExportHistoryExcel" title="<?= __pos_t('pos.reports.export_excel', 'Export Excel') ?>">
                    📊 <?= __pos_t('pos.reports.export_excel', 'Export Excel') ?>
                </button>
                <button class="btn btn-sm btn-secondary" id="posRefreshHistory">
        ...
        <div class="pos-filters-bar" id="posHistoryFilters">
            ...
            <button class="btn btn-sm btn-secondary" id="posResetHistoryFilter">
    ...
    <div class="pos-panel" id="posReportsPanel" style="display:none">
        <div class="pos-panel-header">
            ...
            <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
                <button class="btn btn-sm btn-secondary pos-export-btn" id="posExportCSV" title="<?= __pos_t('pos.reports.export_csv', 'Export CSV') ?>">
                    📥 <?= __pos_t('pos.reports.export_csv', 'Export CSV') ?>
                </button>
                <button class="btn btn-sm btn-secondary pos-export-btn" id="posExportExcel" title="<?= __pos_t('pos.reports.export_excel', 'Export Excel') ?>">
                    📊 <?= __pos_t('pos.reports.export_excel', 'Export Excel') ?>
                </button>
                <button class="btn btn-sm btn-secondary" id="posRefreshReports">
                    🔄 <?= __pos_t('common.refresh', 'Refresh') ?>
                </button>
            </div>
        </div>
        ...
        <div class="pos-filters-bar" id="posReportsFilters">
            ...
            <button class="btn btn-sm btn-secondary" id="posResetReportsFilter">
                ↺ <?= __pos_t('pos.reports.reset_filter', 'Reset') ?>
            </button>
        </div>
    ...
    <div class="pos-camera-overlay" id="posCameraOverlay" style="display:none">
        <div class="pos-camera-box">
            ...
            <div style="text-align:center;margin-top:8px">
                <button class="btn btn-secondary btn-sm" id="posCameraStop">
...
<script src="/admin/assets/js/pages/pos.js?v=<?= assetVer() ?>"></script>
<?php else: ?>
