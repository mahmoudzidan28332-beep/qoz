            ...
            <form id="categoryForm" novalidate>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="catTenantId">
                            <span data-i18n="form.fields.tenant_id.label"><?= __t('form.fields.tenant_id.label', 'Tenant ID') ?></span>
                            <?php if (is_super_admin()): ?>
                            <small style="color:var(--text-secondary,#94a3b8); font-weight:normal;" data-i18n="form.fields.tenant_id.optional">(<?= __t('form.fields.tenant_id.optional', 'Leave empty for Global') ?>)</small>
                            <?php endif; ?>
                        </label>
                        <input type="number" 
                               id="catTenantId" 
                               ...
                               placeholder="<?= __t('form.fields.tenant_id.placeholder', 'e.g., 1 or leave empty') ?>">
...
window.APP_CONFIG.TENANT_ID = window.APP_CONFIG.TENANT_ID !== undefined ? window.APP_CONFIG.TENANT_ID : <?= json_encode($tenantId) ?>;
window.APP_CONFIG.CSRF_TOKEN = window.APP_CONFIG.CSRF_TOKEN || '<?= addslashes($csrf) ?>';
window.APP_CONFIG.USER_ID = window.APP_CONFIG.USER_ID !== undefined ? window.APP_CONFIG.USER_ID : <?= json_encode(admin_user_id()) ?>;
